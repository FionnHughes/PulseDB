...
namespace pulsedb {
    ...
    protected:
        // creates and opens a test .pulse file with 60 readings
        void SetUp() override {
    ...
    // queries the whole time range and expects all 60 readings back
    ...
    // queries a subset of the range and expects those readings
    ...
    // queries outside the file's time range and expects zero results
